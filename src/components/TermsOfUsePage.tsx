    ...
    <div style={{ fontFamily: Fnt.body, backgroundColor: Clr.white, minHeight: "100vh" }}>
      ...
      <header style={{ backgroundColor: Clr.black, borderBottom: "1px solid rgba(255,255,255,0.08)", position: "sticky", top: 0, zIndex: 50 }}>
        <div style={{ maxWidth: 860, margin: "0 auto", padding: "18px 32px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <Link href={c.backHref} style={{ fontFamily: Fnt.body, fontSize: 14, color: "rgba(255,255,255,0.7)", textDecoration: "none" }}>{c.back}</Link>
          <Link href={c.backHref} style={{ fontFamily: Fnt.heading, fontWeight: 700, fontSize: "0.8rem", color: Clr.white, textDecoration: "none" }}>Sensorama Design</Link>
        </div>
      </header>
      ...
      <main style={{ maxWidth: 860, margin: "0 auto", padding: "56px 32px 96px" }}>
        ...
        <div style={{ display: "flex", gap: 12, marginBottom: 40 }}>
          {(["pt", "en", "es"] as Lang[]).map(l => (
            <Link key={l} href={l === "pt" ? "/terms-of-use" : `/${l}/terms-of-use`}
        ...
        <div style={{ marginTop: 64, paddingTop: 32, borderTop: "1px solid #EBEBEB", display: "flex", gap: 24, flexWrap: "wrap" }}>
          <Link href={c.backHref} style={{ fontFamily: Fnt.body, fontSize: 14, color: Clr.blue, textDecoration: "underline" }}>{c.back}</Link>
          <Link href={lang === "pt" ? "/privacy-policy" : `/${lang}/privacy-policy`} style={{ fontFamily: Fnt.body, fontSize: 14, color: Clr.medGray, textDecoration: "underline" }}>Privacy Policy</Link>
          <Link href={lang === "pt" ? "/cookie-policy" : `/${lang}/cookie-policy`} style={{ fontFamily: Fnt.body, fontSize: 14, color: Clr.medGray, textDecoration: "underline" }}>Cookie Policy</Link>
        </div>
      </main>
    </div>
  );

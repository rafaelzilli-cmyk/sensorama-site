      ...
      <span key={i} style={{ display: "block", marginBottom: 4 }}>
        {tokens.map((token, j) => {
          ...
          if (linkMatch) {
            ...
            const style = { color: Clr.blue, textDecoration: "underline", marginRight: href.startsWith("http") ? 8 : 0 };
            if (isExternal) {
              return (
                <a key={j} href={href} style={style}
            ...
            return (
              <Link key={j} href={href} style={style}>
                {linkMatch[1]}
              </Link>
            );
          }
      ...
      <main style={{ maxWidth: 860, margin: "0 auto", padding: "56px 32px 96px" }}>
        <div style={{ display: "flex", gap: 12, marginBottom: 40 }}>
          {(["pt", "en", "es"] as Lang[]).map(l => (
            <Link key={l} href={l === "pt" ? "/cookie-policy" : `/${l}/cookie-policy`}
        ...
        <div style={{ marginTop: 64, paddingTop: 32, borderTop: "1px solid #EBEBEB", display: "flex", gap: 24, flexWrap: "wrap" }}>
          ...
          <Link href={lang === "pt" ? "/privacy-policy" : `/${lang}/privacy-policy`}
          ...
          <Link href={lang === "pt" ? "/terms-of-use" : `/${lang}/terms-of-use`}
            style={{ fontFamily: Fnt.body, fontSize: 14, color: Clr.medGray, textDecoration: "underline" }}>

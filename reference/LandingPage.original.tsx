...
import logoItau      from "figma:asset/1d28786bbcfa5e99be4ce128cb30c95a4b3378bc.png";
import logoUnilever  from "figma:asset/f189c99d429b58943d2d6fc83955d5420185f1a8.png";
import logoAbInBev   from "figma:asset/56d075b2adad74c31bae6639bb7333362c6576d2.png";
import logo99        from "figma:asset/d0210fe9d7e74ca0ab3a01f77e7f944ba417961b.png";
import logoNestle    from "figma:asset/84180131ab802cf17e492e4acfc1c4687f7c8d1e.png";
import logoNubank    from "figma:asset/6b9d1f3597ecf5b183d97aa3893f20d0a5738eb9.png";
import logoTotvs     from "figma:asset/50a4747c0f5d44119e9b4b2c0c3453aac028ce8c.png";
import logoVale      from "figma:asset/12235c05641b33e8e1bcf293f52fd69bf7100340.png";
import logoMondelez  from "figma:asset/bf44deac2f7375e668d650c559be94e344182e2c.png";
import logoRandon    from "figma:asset/4360d4c34be551390de27d305f9d894e59b07948.png";

/* ─── New client logos ─── */
import logoCogna    from "figma:asset/d387d0130cb2c9075c575b7ffa93fddd9f8f902e.png";
import logoEngie    from "figma:asset/bf93bef0cee976779c346293e54538e456b465a3.png";
import logoThomson  from "figma:asset/9d023efcb79946f685b0f0870376ee8203b9c42b.png";

/* ─── Sensorama brand images ─── */
import imgEye       from "figma:asset/22301359834e110b7ca892d9eabdd709358be9f6.png";
import imgLgpdSeal  from "figma:asset/6882aad92f2107f722053c25ee9010f0a22e79e9.png";
import imgTeam      from "figma:asset/78b07f978f4d9408394740f807d2032acb1fd378.png";
import imgWorkshop  from "figma:asset/0b8f16d301ec732c5711fe779a39a3b3c90ee211.png";
import imgWeconnect from "figma:asset/744eb615d839dc24e220ec88e4c797bcf6063c57.png";
...
import caseImgBees   from "figma:asset/57244c4067071e1afb1da9f85c9d2f1af87ded3a.png";
...
/* ═══════════════════════════════════════════════════════════════
   SEO HEAD — react-helmet-async with full meta + JSON-LD
═══════════════════════════════════════════════════════════════ */
function SEOHead({ lang }: { lang: Lang }) {
  const BASE = "https://www.sensoramadesign.com";
  const langPath: Record<Lang, string> = { pt: "/", en: "/en/", es: "/es/" };
  const canonical = `${BASE}${langPath[lang]}`;

  const htmlLang: Record<Lang, string> = { pt: "pt-BR", en: "en", es: "es" };
  const ogLocale: Record<Lang, string> = { pt: "pt_BR", en: "en_US", es: "es_ES" };

  const titles: Record<Lang, string> = {
    pt: "Sensorama Design | Pesquisa UX, Design de Serviços & Transformação Digital",
    en: "Sensorama Design | UX Research, Service Design & Digital Transformation",
    es: "Sensorama Design | Investigación UX, Diseño de Servicios & Transformación Digital",
  };

  const descriptions: Record<Lang, string> = {
    pt: "Consultoria brasileira de inovação liderada por mulheres. UX design, pesquisa aprofundada e inteligência artificial para resolver problemas reais. 13+ anos, 50+ clientes, 200+ projetos em 10+ países. Clientes: Itaú, Nubank, AB InBev, J&J, Ambev/BEES e outros.",
    en: "Brazilian women-led innovation consultancy. UX design, deep research, and AI to solve real problems. 13+ years, 50+ clients, 200+ projects across 10+ countries. Clients include Itaú, Nubank, AB InBev, J&J, Ambev/BEES and more.",
    es: "Consultoría brasileña de innovación liderada por mujeres. UX design, investigación profunda e IA. 13+ años, 50+ clientes, 200+ proyectos en 10+ países. Clientes: Itaú, Nubank, AB InBev, J&J, Ambev/BEES y más.",
  };
  ...
  const organizationSchema = {
    ...
    "alternateName": "Sensorama",
    "url": "https://www.sensoramadesign.com",
    "email": "contato@sensoramadesign.com",
    "description": "Brazilian women-led innovation consultancy specializing in UX Design, Research, and Digital Transformation. Operating across Brazil, LATAM, US, and Europe. 13+ years of experience.",
    "foundingDate": "2011",
    "areaServed": ["Brazil", "United States", "Latin America", "Europe"],
    "knowsAbout": [
      "UX Research", "Service Design", "Product Design",
      "Digital Transformation", "AI Enablement", "Innovation Workshops",
      "Customer Journey Mapping", "Usability Testing"
    ],
    "hasCredential": [
      "WEConnect International Women-Owned Business Certification",
      "LGPD Data Guide Verified Company"
    ],
    "sameAs": [
      "https://www.instagram.com/sensoramadesign/",
      "https://www.linkedin.com/company/sensoramadesign/",
      "https://inspiredbypeople.medium.com/"
    ],
    "contactPoint": {
      "@type": "ContactPoint",
      "email": "contato@sensoramadesign.com",
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What services does Sensorama Design offer?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Sensorama Design offers UX Research, Service Design, Product Design, Digital Transformation, AI Enablement, Innovation Workshops, Customer Journey Mapping, Ethnographic Studies, Usability Testing, and AI Strategy consulting."
        }
      },
      {
        "@type": "Question",
        "name": "How many years of experience does Sensorama Design have?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Sensorama Design has over 13 years of experience, having delivered 200+ projects for 50+ clients across 10+ countries in LATAM, the United States, and Europe."
        }
      },
      {
        "@type": "Question",
        "name": "Which companies has Sensorama Design worked with?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Sensorama Design has worked with leading companies including AB InBev, Ambev, BEES, Itaú, Nubank, Johnson & Johnson, Senac, Cogna, Engie, Thomson Reuters, Unilever, Nestlé, Vale, TOTVS, Mondelēz, and Randon."
        }
      },
      {
        "@type": "Question",
        "name": "What is Sensorama Design's approach to innovation?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Sensorama integrates research, design, and transformation through hybrid systems where human expertise and AI agents work together. Their approach combines deep user research, strategic design, and AI to solve real business problems and drive meaningful change."
        }
      },
      {
        "@type": "Question",
        "name": "Is Sensorama Design women-led?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes, Sensorama Design is a women-led innovation consultancy. They are certified by WEConnect International as a Women-Owned Business and are a LGPD Data Guide verified company."
        }
      },
      {
        "@type": "Question",
        "name": "How can I contact Sensorama Design?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "You can contact Sensorama Design by email at contato@sensoramadesign.com, through the contact form on their website, or via their LinkedIn and Instagram channels."
        }
      }
    ]
  };
  ...
  return (
    <Helmet>
      ...
      <meta name="google-site-verification" content="vdqTU6GP-uLvayyHdQuiUMBxgVlRZDTzCHMKWc0HZMI" />
      <meta name="google-site-verification" content="62502e77dfb3d39e" />
      <meta name="keywords" content="UX design, UX research, service design, digital transformation, AI, innovation consultancy, Brazilian consultancy, women-led, design thinking, product design, Brazil, LATAM" />
      <meta name="author" content="Sensorama Design" />
      ...
      <meta property="og:site_name"   content="Sensorama Design" />
      ...
      <meta name="twitter:site"        content="@sensoramadesign" />
...
export function Navbar({ lang, langUrls, sectionHrefPrefix = "" }: { lang: Lang; langUrls?: Record<Lang, string>; sectionHrefPrefix?: string }) {
  ...
  const linkHref = (i: number) => (ids[i] === "cases" ? casesUrl : `${sectionHrefPrefix}#${ids[i]}`);
  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: 1152, margin: "0 auto", padding: "0 24px", width: "100%", display: "flex", alignItems: "center", justifyContent: "space-between", height: 64, boxSizing: "border-box" }}>
        {/* Logo — desktop only */}
        <a href={LANG_URLS[lang]} aria-label="Sensorama Design — Home" className="hidden md:block" style={{ flexShrink: 0 }}>
        ...
        <nav aria-label="Main navigation" className="hidden md:flex" style={{ alignItems: "center", gap: 32 }}>
          {t.nav.links.map((link, i) => (
            <a
              key={link}
              href={linkHref(i)}
              style={{ color: "rgba(255,255,255,0.7)", fontFamily: F.body, fontSize: 14, fontWeight: 500, textDecoration: "none" }}
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          {/* Lang switcher — crawlable <a href> links */}
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 4, marginBottom: 20 }}>
            {t.nav.links.map((link, i) => (
              <a
                ...
                style={{ color: "rgba(255,255,255,0.75)", fontFamily: F.body, fontSize: 15, fontWeight: 500, textDecoration: "none", padding: "10px 0", borderBottom: "1px solid rgba(255,255,255,0.06)", display: "block" }}>
                {link}
              </a>
            ))}
          </div>
      ...
      <div style={{ maxWidth: 1152, margin: "0 auto", padding: "64px 32px 48px" }}>
          ...
          <nav aria-label="Footer navigation">
            ...
            <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 12 }}>
              {t.footer.navLinks.map((l) => (
                <li key={l.label}>
                  <a href={l.href} style={{ fontFamily: F.body, fontSize: 14, color: "rgba(255,255,255,0.6)", textDecoration: "none" }}>{l.label} →</a>
                </li>
              ))}
            </ul>
        ...
        <div style={{ borderTop: "1px solid rgba(255,255,255,0.08)", paddingTop: 28, display: "flex", flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 16 }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 16, alignItems: "center" }}>
            {(t.footer as typeof t.footer & { legalLinks: {label: string; href: string}[]; manageCookies: string }).legalLinks.map((l) => (
              <a key={l.label} href={l.href} style={{ fontFamily: F.body, fontSize: 12, color: "rgba(255,255,255,0.3)", textDecoration: "none" }}
            ...
            >
              {(t.footer as typeof t.footer & { manageCookies: string }).manageCookies}
            </button>
          </div>
        </div>
      </div>
